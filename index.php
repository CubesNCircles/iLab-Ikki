...
<head>
	...
	<link href="assets/css/add2home.css" rel="stylesheet">
	...
	<script>
	  ...
	  ga('create', 'UA-39536445-1', 'nicolaswidart.com');
	  ga('send', 'pageview');
...
<div class="container-fluid">
	<div class="row">
			<div class="alert alert-block">
				...
				<h4>Intro</h4>
				<p class="text-error">It's better to view this Web app after placing it on the homescreen.</p>
